  ...
  <div class="drawer xl:drawer-open">
    ...
    <div class="drawer-content flex flex-col min-h-screen">
      ...
      <div class="navbar bg-base-100 shadow-xs">
        ...
        <div class="flex-1">
          <a class=" normal-case text-xl">{{ $title }}</a>
        </div>
      ...
      @if ($breadcrumbs)
        <div class="text-sm breadcrumbs px-6 py-4 mt-5 bg-base-200">
          <ul>
            {{ $breadcrumbs }}
          </ul>
        </div>
    ...
    <div class="drawer-side ">
      ...
      <aside class="bg-base-100 min-h-screen w-60">
        ...
        <ul class="menu w-full px-4 py-0 mt-5">
          ...
          <x-daisyui.menu-item text="Users" href="" active="admin" />
          ...
          <x-daisyui.menu-group icon="fas fa-folder" text="Content">
            <x-daisyui.menu-item icon="fas fa-posts" text="Posts" href="" active="admin-new3" />
            <x-daisyui.menu-item icon="fas fa-pages" text="Pages" href="" active="admin-new1" />
            <x-daisyui.menu-item icon="fas fa-media" text="Media" href="" active="admin-new2" />
